  ...
  return (
    ...
    <ul className="flex gap-4 font-light menu-horizontal px-1">
      ...
      <li><NavLink to='/about'>{translation.about}</NavLink></li>
          ...
          {/* Language */}
          <select
            className="select py-[1px] px-2 w-[60px]  max-w-xs ms-auto dark:text-black dark:bg-slate-300"
                  ...
                  <div className="card-body ">
                    ...
                    <Link to={"../cart"}>
                      <div className="card-actions ">
                        <button className="btn bg-purple-300 btn-block hover:bg-purple-500 ">
                          View cart
                        </button>
                      </div>
                    </Link>
