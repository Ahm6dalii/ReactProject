        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
          <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
            ...
            <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
              ...
              <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4 dark:text-gray-300">
                {courseData?.title}
              </h2>
              ...
              <div className=" flex flex-row justify-between  mt-5">
                ...
                <p className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-700 hover:underline hover:text-gray-800 duration-100 cursor-pointer dark:text-white ">
                  {courseData?.reviews_count} reviews
                </p>
              </div>
              ...
              <p className="pt-2">
                Created by{" "}
                <span className="text-blue-400 ">{courseData.instructor}</span>
              </p>
          ...
          <div className="border mt-4 p-3 dark:text-white ">
            <h3 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 dark:text-gray-300  text-gray-800 mt-4">
              What you'll learn
            </h3>
            <div className="flex flex-wrap ">
              {courseData?.what_you_will_learn.map((learn) => (
                <p className="flex items-center w-full lg:w-1/2 dark:text-white  font-normal text-lg leading-6 text-gray-600 mt-7 ">
                  <i className="fa-solid fa-check me-2"></i> {learn}
                </p>
              ))}
            </div>
          </div>
          ...
          <div className="my-2">
            <h3 className="font-semibold dark:text-gray-300 lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">
              This course includes:
            </h3>
            <div className="flex flex-wrap ">
              <p className="flex items-center w-full lg:w-1/2 dark:text-white   font-normal text-lg leading-6 text-gray-600 mt-7 ">
                <i className="fa-solid fa-video  me-2"></i>{" "}
                {courseAccess?.hours_of_video} hours on-demand video
              </p>
              <p className="flex items-center w-full lg:w-1/2 dark:text-white   font-normal text-lg leading-6 text-gray-600 mt-7 ">
                <i className="fa-regular fa-file me-2"></i>
                {courseAccess?.articles} articles
              </p>
              <p className="flex items-center w-full lg:w-1/2 dark:text-white   font-normal text-lg leading-6 text-gray-600 mt-7 ">
                <i className="fa-solid fa-download me-2"></i>
                {courseAccess?.downloadable_resources} downloadable resources
              </p>
              <p className="flex items-center w-full lg:w-1/2 dark:text-white   font-normal text-lg leading-6 text-gray-600 mt-7 ">
                <i className="fa-solid fa-mobile-screen me-2"></i>Access On{" "}
                {courseAccess?.access.map(
                  (access, index) => (index > 0 ? " and " : "") + access
                )}{" "}
              </p>
              {courseAccess?.certificate_of_completion && (
                <p className="flex items-center w-full dark:text-white  lg:w-1/2  font-normal text-lg leading-6 text-gray-600 mt-7 ">
                  <i className="fa-solid fa-trophy me-2"></i>Certificate of
                  completion
                </p>
              )}
            </div>
